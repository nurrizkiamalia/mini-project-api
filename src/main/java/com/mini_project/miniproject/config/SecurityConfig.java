...
//                .cors(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers("/api/v1/events/{eventId}").permitAll();
                    auth.requestMatchers("/api/v1/events/search").permitAll();
                    auth.requestMatchers("/api/v1/reviews/event/{eventId}").permitAll();
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://localhost:3001", "https://mini-project.fly.dev", "https://www.eventeuphoria.fun", "https://dashboard.eventeuphoria.fun"));
